...
public class InferredTupleNamesRuleTests
{
    private readonly InferredTupleNamesRule _rule = new();
    ...
    [Fact]
    public void Analyze_NameDoesNotMatchExpression_ReturnsNoDiagnostics()
    {
        string source = """
    ...
    [Fact]
    public void Analyze_NoExplicitName_ReturnsNoDiagnostics()
    {
        string source = """
            class C
            {
    ...
    [Fact]
    public void Analyze_CaseMismatch_ReturnsNoDiagnostics()
    {
        string source = """
            class Person { public string Name { get; set; } }
            class C
