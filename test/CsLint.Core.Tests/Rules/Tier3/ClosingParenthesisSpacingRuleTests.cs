...
public class ClosingParenthesisSpacingRuleTests
{
    private readonly ClosingParenthesisSpacingRule _rule = new();
    ...
    public void Analyze_SpaceBeforeCloseParen_ReturnsDiagnostic()
    {
        ...
        Assert.Contains(diagnostics, d => d.RuleId == "SA1009" && d.Message.Contains("closing"));
    }
