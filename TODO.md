...
- [x] **CSLINT100–106 naming rules** — disabled when standard 3-part naming config is present (IDE1006 takes over)
...
- [x] **Indentation rules** (6) — CSLINT292 (`csharp_indent_case_contents`, `_switch_labels`, `_labels`, `_block_contents`, `_braces`, `_case_contents_when_block`)
...
- [x] **Wrap/preserve rules** (2) — CSLINT293 (`csharp_preserve_single_line_statements`, `csharp_preserve_single_line_blocks`)
